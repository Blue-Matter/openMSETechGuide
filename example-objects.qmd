...
Three `Stock` objects are provided, representing species with contrasting life histories and model configurations. See @sec-examplestocks for full construction details.
...
Five pre-assembled `OM` objects combine the example stocks, fleets, and observation programs in configurations of increasing complexity. All are initialised with `nSim = 8`, `nYear = 20`, and `pYear = 30`. See @sec-exampleOM for full construction details.
