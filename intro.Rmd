...
`openMSE` is open source software for Management Strategy Evaluation. 

This Technical Guide has been developed for `openMSE 2.0`, which is currently under development and will be released in 2025. 
...
## Getting Started
For first time users of `openMSE`, we recommend reading through the following sub-sections, and then taking the [Quick Tour](/quicktour.html) of `openMSE`.
