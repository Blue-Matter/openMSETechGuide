...
Four example `OM` objects are provided, covering the most common configurations of stocks, fleets, and observation programmes. All use the example `Stock` and `Fleet` objects described in @sec-examplestocks and @sec-examplefleets, and the example `Obs` objects described in @sec-exampleobs.
